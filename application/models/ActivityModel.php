...
class ActivityModel extends Lumine_Base {
	...
	protected function _initialize() {
		...
		$this->metadata()->addRelation('expenses', Lumine_Metadata::ONE_TO_MANY, 'ExpenseModel', 'activity', null, null, null);
		$this->metadata()->addRelation('repayment', Lumine_Metadata::ONE_TO_MANY, 'RepaymentModel', 'activity', null, null, null);
	}
